...
public class NordstromSynchroniser extends ProductSynchronizer {

	public NordstromSynchroniser(String url) {
		super(url);
		// TODO Auto-generated constructor stub
	}

	public static void main(String[] args) throws Exception {
		ProductSynchronizer synchronizer = new NordstromSynchroniser
